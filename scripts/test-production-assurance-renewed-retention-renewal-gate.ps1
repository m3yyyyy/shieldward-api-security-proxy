...
if (
    ...
    throw 'Renewed production assurance retention-renewal approval is stale, future-dated, expired, or insufficient.'
}
if (
    ...
    throw 'Renewed retention renewal is not approved; do not change the external archive.'
}

Write-Host "Renewed production assurance retention-renewal approval gate passed for change $($plan.changeId)."
