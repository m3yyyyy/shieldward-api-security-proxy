...
& (Join-Path $PSScriptRoot 'test-production-assurance-renewed-custody-recurring-evidence.ps1') @validationArguments 6>$null
...
if (
    ...
    throw 'The recurring renewed custody-review evidence is stale, future-dated, overdue, or outside renewed retention.'
}
if (
    ...
    throw 'Recurring renewed custody continuity is not proven; do not continue the review chain.'
}

Write-Host "Recurring production assurance renewed custody-review gate passed at sequence $($evidence.review.sequence)."
