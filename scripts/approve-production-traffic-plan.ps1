...
& (Join-Path $PSScriptRoot 'test-production-traffic-plan.ps1') @validationArguments | Out-Null
...
& (Join-Path $PSScriptRoot 'test-production-traffic-plan.ps1') @approvedValidationArguments | Out-Null

Write-Host "Production canary plan approved for change $($plan['changeId'])."
