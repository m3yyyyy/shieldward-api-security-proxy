...
$plan['decision']['nextAction'] = 'execute-approved-external-generation-5-retention-renewal'
...
& (Join-Path $PSScriptRoot 'test-production-assurance-generation-5-retention-renewal-plan.ps1') @approvedArguments 6>$null

Write-Host "Generation-5 production assurance retention-renewal plan approved for change $($plan['changeId'])."
