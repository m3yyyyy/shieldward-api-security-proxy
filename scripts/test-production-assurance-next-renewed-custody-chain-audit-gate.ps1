...
if (
    ...
    [string]$evidence.audit.nextRenewedChainInventoryStatus -ne 'complete' -or
...
Write-Host "Next renewed production assurance custody chain-audit gate passed through sequence $($evidence.chain.headSequence)."
