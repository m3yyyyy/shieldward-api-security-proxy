...
if (
    ...
    throw 'The sequence-10 custody-review evidence is stale, future-dated, overdue for its next review, or outside renewed retention.'
}
if (
    ...
    [int]$evidence.review.sequence -ne 10 -or
    ...
    throw 'Generation-4 custody continuity is not proven; do not continue its review chain.'
}

Write-Host "Generation-4 custody-review gate passed at generation 4 sequence $($evidence.review.sequence)."
