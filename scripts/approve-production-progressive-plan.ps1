...
& (Join-Path $PSScriptRoot 'test-production-progressive-plan.ps1') @validationArguments | Out-Null
...
& (Join-Path $PSScriptRoot 'test-production-progressive-plan.ps1') @approvedValidationArguments | Out-Null

Write-Host "Production progressive expansion plan approved for change $($plan['changeId'])."
