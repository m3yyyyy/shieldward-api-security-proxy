...
if (
    ...
    throw 'Next renewed production assurance retention-renewal approval is stale, future-dated, expired, or insufficient.'
}
if (
    ...
    throw 'Next-renewed retention renewal is not approved; do not change the external archive.'
}

Write-Host "Next renewed production assurance retention-renewal approval gate passed for change $($plan.changeId)."
