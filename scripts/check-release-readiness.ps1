...
foreach ($relativePath in @(
    ...
    'docs/production-assurance-generation-4-retention-renewal.md'
    'docs/production-assurance-generation-4-retention-renewal-evidence.md'
    'docs/production-assurance-generation-5-custody-baseline.md'
    'docs/production-assurance-generation-5-custody-review.md'
    ...
    'scripts/new-production-assurance-generation-4-retention-renewal-plan.ps1'
    'scripts/test-production-assurance-generation-4-retention-renewal-plan.ps1'
    'scripts/approve-production-assurance-generation-4-retention-renewal-plan.ps1'
    'scripts/test-production-assurance-generation-4-retention-renewal-gate.ps1'
    'scripts/test-production-assurance-generation-4-retention-renewal-contract.ps1'
    'scripts/new-production-assurance-generation-4-retention-renewal-evidence.ps1'
    'scripts/test-production-assurance-generation-4-retention-renewal-evidence.ps1'
    'scripts/test-production-assurance-generation-4-retention-renewal-evidence-gate.ps1'
    'scripts/test-production-assurance-generation-4-retention-renewal-evidence-contract.ps1'
    'scripts/new-production-assurance-generation-5-custody-baseline.ps1'
    'scripts/test-production-assurance-generation-5-custody-baseline.ps1'
    'scripts/test-production-assurance-generation-5-custody-baseline-gate.ps1'
    'scripts/test-production-assurance-generation-5-custody-baseline-contract.ps1'
    'scripts/new-production-assurance-generation-5-custody-review-evidence.ps1'
    'scripts/test-production-assurance-generation-5-custody-review-evidence.ps1'
    'scripts/test-production-assurance-generation-5-custody-review-gate.ps1'
    'scripts/test-production-assurance-generation-5-custody-review-contract.ps1'
    'scripts/new-production-assurance-generation-5-custody-recurring-evidence.ps1'
    'scripts/test-production-assurance-generation-5-custody-recurring-evidence.ps1'
    'scripts/test-production-assurance-generation-5-custody-recurring-gate.ps1'
    'scripts/test-production-assurance-generation-5-custody-recurring-contract.ps1'
    'scripts/new-production-assurance-generation-5-custody-chain-audit-evidence.ps1'
    'scripts/test-production-assurance-generation-5-custody-chain-audit-evidence.ps1'
    'scripts/test-production-assurance-generation-5-custody-chain-audit-gate.ps1'
    'scripts/test-production-assurance-generation-5-custody-chain-audit-contract.ps1'
    'scripts/new-production-assurance-generation-5-retention-renewal-plan.ps1'
    'scripts/test-production-assurance-generation-5-retention-renewal-plan.ps1'
    ...
    'scripts/new-production-assurance-generation-6-custody-baseline.ps1'
    'scripts/test-production-assurance-generation-6-custody-baseline.ps1'
    'scripts/test-production-assurance-generation-6-custody-baseline-gate.ps1'
    'scripts/test-production-assurance-generation-6-custody-baseline-contract.ps1'
    'scripts/new-production-assurance-generation-6-custody-review-evidence.ps1'
    'scripts/test-production-assurance-generation-6-custody-review-evidence.ps1'
    'scripts/test-production-assurance-generation-6-custody-review-gate.ps1'
    'scripts/test-production-assurance-generation-6-custody-review-contract.ps1'
    'scripts/new-production-assurance-generation-6-custody-recurring-evidence.ps1'
