...
if (
    ...
    throw 'The sequence-7 custody-review evidence is stale, future-dated, overdue for its next review, or outside renewed retention.'
}
if (
    ...
    [int]$evidence.review.sequence -ne 7 -or
    ...
    throw 'Generation-3 custody continuity is not proven; do not continue its review chain.'
}

Write-Host "Next renewed custody-review gate passed at generation 3 sequence $($evidence.review.sequence)."
