...
if (
    ...
    throw 'The renewed custody-review evidence is stale, future-dated, overdue for its next review, or outside renewed retention.'
}
if (
    ...
    throw 'Renewed custody continuity is not proven; do not continue the renewed review chain.'
}

Write-Host "Production assurance renewed custody-review gate passed at sequence $($evidence.review.sequence)."
