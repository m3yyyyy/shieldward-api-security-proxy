...
if (
    ...
    throw 'The sequence-16 custody-review evidence is stale, future-dated, overdue for its next review, or outside renewed retention.'
}
if (
    ...
    [int]$evidence.review.sequence -ne 16 -or
    ...
    throw 'Generation-6 custody continuity is not proven; do not continue its review chain.'
}

Write-Host "Generation-6 custody-review gate passed at generation 6 sequence $($evidence.review.sequence)."
