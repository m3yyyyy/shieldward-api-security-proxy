...
& (Join-Path $PSScriptRoot 'test-production-second-expansion-plan.ps1') @validationArguments | Out-Null
...
& (Join-Path $PSScriptRoot 'test-production-second-expansion-plan.ps1') @approvedValidationArguments | Out-Null

Write-Host "Production second expansion plan approved for change $($plan['changeId'])."
