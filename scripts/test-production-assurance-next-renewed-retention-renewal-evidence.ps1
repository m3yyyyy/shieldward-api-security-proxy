...
if([int]$evidence.schemaVersion-ne 1-or[string]$evidence.environment-ne'production'-or[string]$evidence.evidenceType-ne'production-assurance-next-renewed-retention-renewal-evidence'){
...
& (Join-Path $PSScriptRoot 'test-production-assurance-next-renewed-retention-renewal-plan.ps1') @planValidationArguments 6>$null
...
$integrity=[ordered]@{
    ...
    nextRenewedBaselineSha256=[string]$plan.lineage.nextRenewedBaselineSha256;nextRenewedBaselineIntegrityDigest=[string]$plan.lineage.nextRenewedBaselineIntegrityDigest;nextRenewedLineageDigest=[string]$plan.lineage.nextRenewedLineageDigest;previousRenewalEvidenceSha256=[string]$plan.lineage.previousRenewalEvidenceSha256;previousRenewalEvidenceIntegrityDigest=[string]$plan.lineage.previousRenewalEvidenceIntegrityDigest;inheritedLineageDigest=Get-Sha256Text -Text ($plan.lineage.inheritedLineage|ConvertTo-Json -Depth 12 -Compress);nextRenewedReviewChainDigest=[string]$plan.lineage.nextRenewedReviewChainDigest;nextRenewedReviewHeadSequence=[int]$plan.lineage.nextRenewedReviewHeadSequence
...
Write-Host "Next renewed production assurance retention-renewal evidence validation passed with outcome '$expectedOutcome'."
