...
$plan['decision']['nextAction'] = 'execute-approved-external-next-renewed-retention-renewal'
...
& (Join-Path $PSScriptRoot 'test-production-assurance-next-renewed-retention-renewal-plan.ps1') @approvedArguments 6>$null

Write-Host "Next renewed production assurance retention-renewal plan approved for change $($plan['changeId'])."
