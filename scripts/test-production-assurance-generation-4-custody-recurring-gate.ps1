...
& (Join-Path $PSScriptRoot 'test-production-assurance-generation-4-custody-recurring-evidence.ps1') @validationArguments 6>$null
...
if (
    ...
    throw 'Recurring generation-4 custody-review evidence is stale, future-dated, overdue, or outside retention.'
}
if (
    ...
    [int]$evidence.review.sequence -lt 11 -or
    ...
    throw 'Recurring generation-4 custody continuity is not proven; do not continue the review chain.'
}

Write-Host "Recurring generation-4 custody-review gate passed at sequence $($evidence.review.sequence)."
