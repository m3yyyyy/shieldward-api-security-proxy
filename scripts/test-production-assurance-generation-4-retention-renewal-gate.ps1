...
if (
    ...
    throw 'Generation-4 production assurance retention-renewal approval is stale, future-dated, expired, or insufficient.'
}
if (
    ...
    throw 'Generation-4 retention renewal is not approved; do not change the external archive.'
}

Write-Host "Generation-4 production assurance retention-renewal approval gate passed for change $($plan.changeId)."
