...
$plan['decision']['nextAction'] = 'execute-approved-external-generation-4-retention-renewal'
...
& (Join-Path $PSScriptRoot 'test-production-assurance-generation-4-retention-renewal-plan.ps1') @approvedArguments 6>$null

Write-Host "Generation-4 production assurance retention-renewal plan approved for change $($plan['changeId'])."
