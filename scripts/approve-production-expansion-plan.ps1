...
& (Join-Path $PSScriptRoot 'test-production-expansion-plan.ps1') @validationArguments | Out-Null
...
& (Join-Path $PSScriptRoot 'test-production-expansion-plan.ps1') @approvedValidationArguments | Out-Null

Write-Host "Production expansion plan approved for change $($plan['changeId'])."
