...
if (
    ...
    throw 'The sequence-13 custody-review evidence is stale, future-dated, overdue for its next review, or outside renewed retention.'
}
if (
    ...
    [int]$evidence.review.sequence -ne 13 -or
    ...
    throw 'Generation-5 custody continuity is not proven; do not continue its review chain.'
}

Write-Host "Generation-5 custody-review gate passed at generation 5 sequence $($evidence.review.sequence)."
