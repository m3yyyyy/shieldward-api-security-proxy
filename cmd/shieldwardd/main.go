...
Usage:
  ...
  shieldwardd serve -policy <path> [-private-key <path>] [-listen <address>] [-tls-cert <path> -tls-key <path>] [-client-ca <path> -client-identity <spiffe-uri>] [-tls-reload-interval <duration>]
